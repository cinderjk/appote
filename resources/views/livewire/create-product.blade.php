<div>
    ...
    <div class="  dark:border-gray-700">
        ...
        @error('name')
        <div class="font-medium text-red-600 dark:text-red-400 mb-3">
            {{ $message }}
        </div>
        @enderror
        ...
        <div wire:ignore class="mb-3">
            ...
            <input wire:model="price" type="text" id="price"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Harga" x-mask:dynamic="$money($input, ',')">
        </div>
        @error('price')
        <div class="font-medium text-red-600 dark:text-red-400 mb-3">
            {{ $message }}
            ...
            <div x-show="open">
                ...
                <div class="mb-3">
                    ...
                    <input wire:model="sale_price" type="text" id="sale_price"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Harga Promo" x-mask:dynamic="$money($input, ',')">
                </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            <div x-data="{
                ...
                <label class="block mb-3 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Unggah
                    Foto (opsional)</label>
                <template x-if="imgsrc">
                    <img :src="imgsrc" class="object-cover rounded border border-gray-200"
                        style="width: 100px; height: 100px;">
                </template>

                <template x-if="! imgsrc">
                    <img src="{{ asset('assets/placeholder.jpg') }}" class="object-cover rounded border border-gray-200"
                        style="width: 100px; height: 100px;">
                </template>
                ...
                <input wire:model="image"
                    ...
                    type="file" accept="image/*" x-ref="image" aria-describedby="file_input_help" id="file_input">
