<div
    class="p-12 md:px-22 bg-white border border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700 grid content-center">
    <form wire:submit="login" class="space-y-5">
        <img src="{{ asset('assets/logo.png') }}" alt="logo-{{ config('app.name') }}" class="h-16 m-auto">
        <h5 class="text-xl font-medium text-gray-900 dark:text-white md:px-32">Masuk ke {{ config('app.name') }}
        </h5>
        <div>
            ...
            <div class="flex items-start">
                <div class="flex items-center h-5">
                    <input id="remember" type="checkbox"
                        class="w-4 h-4 border border-gray-300  bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800">
                </div>
        ...
        @error('username')
        <div class="p-4 mb-4 text-sm text-red-800  bg-red-50 dark:bg-gray-700 dark:text-red-400" role="alert">
