...
<body class="dark:bg-gray-900">
    ...
    <button wire:ignore data-drawer-target="sidebar" data-drawer-toggle="sidebar" aria-controls="sidebar"
    ...
    <aside id="sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <a href="{{ route('dashboard') }}" class="flex items-center ps-2.5 mb-5">
                <img src="{{ asset('assets/logo.png') }}" class="h-16" alt="{{ config('app.name') }} Logo" />
            </a>
    ...
    <div class="p-4 sm:ml-64 dark:bg-gray-900 min-h-screen">
        ...
        <button id="theme-toggle" type="button"
            class="fixed bottom-5 right-5 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-3 bg-gray-200 dark:bg-gray-700">
